...
if __name__ == '__main__':
    ...
    # Training parameters
    parser.add_argument('--kfold', default=1, type=int, help='Number of folds for cross validation') #default=5
    parser.add_argument('--epochs', default=5, type=int, help='Number of epochs per fold') #default=100

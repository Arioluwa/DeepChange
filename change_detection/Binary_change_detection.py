...
#     # change matrix
    ...
    if args.percent:
        ...
        cm_plot_per = sns.heatmap(cm_per, annot=True, fmt='.2%', cmap='Blues', xticklabels=label, yticklabels=label, cbar=False, annot_kws={"size": 30})
        cm_plot_per.set(xlabel= "Predicted", ylabel= "Ground truth")
        # save the plot
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_source', '-ps', default='../../../results/ltae/classificationmap/2018_LTAE_case_1_map.tif', type=str, help='Source classification map')
    parser.add_argument('--pred_target', '-pt', default='../../../results/ltae/classificationmap/2019_LTAE_case_2_map.tif', type=str, help='Target  classification map')
    parser.add_argument('--percent', '-p', default=True, type=bool, help='Cal percent in the confusion matrix')
    
    args = parser.parse_args()
    # main(args)
    # args = vars(args) # if needed as a dict... call as args['case']
    # results/RF/classificationmap/2018_rf_case_1_map.tif
    # execute for RF
    # for case in range(1, 4):
    #     args.case = str(case)
    #     args.outdir = '../../../results/RF/bcd'
    #     args.pred_source = '../../../results/RF/classificationmap/2018_rf_case_{}_map.tif'.format(case)
    #     args.pred_target = '../../../results/RF/classificationmap/2019_rf_case_{}_map.tif'.format(case)
    #     main(args)
    ...
    # args.outdir = '../../../results/RF/bcd'
    # # args.percent = True
    # args.pred_source = '../../../results/RF/classificationmap/2018_rf_case_1_map.tif'
    # args.pred_target = '../../../results/RF/classificationmap/2019_rf_case_2_map.tif'
    # main(args)
    # print('Case {} done'.format(args.case))
    # results/ltae/classificationmap/2018_LTAE_case_{}_map.tif
    #ltae
    # for case in range(2,4):
    #     args.case = str(case)
    #     args.pred_source = '../../../results/ltae/classificationmap/2018_LTAE_case_{}_map.tif'.format(case)
    #     args.pred_target = '../../../results/ltae/classificationmap/2019_LTAE_case_{}_map.tif'.format(case)
    ...
    args.case = "1"
    # args.percent = True
    args.pred_source = '../../../results/ltae/classificationmap/2018_LTAE_case_1_map.tif'
    args.pred_target = '../../../results/ltae/classificationmap/2019_LTAE_case_1_map.tif'
    args.outdir = "../../../results/ltae/Change_detection/bcd"
    main(args)
    print('Case {} done'.format(args.case))